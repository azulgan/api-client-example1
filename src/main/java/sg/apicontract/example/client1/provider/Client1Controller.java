package sg.apicontract.example.client1.provider;
...
import sg.apicontract.example.client1.dto.ProcessResultBean;
...
public class Client1Controller {
    ...
    public ProcessResultBean process(@RequestParam(name="processName", required=false, defaultValue="calculation") String name) {
        ...
        ProcessResultBean ret = new ProcessResultBean("Processed: " + name, res.getMessage());
        return ret;
    }
